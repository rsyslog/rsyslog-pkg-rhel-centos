...
REPOOPTIONS="v5-stable v7-stable v8-stable v8-devel2 v8-q-debug v8-stable-gt v8-stable-cs v8-stable-sb v8-stable-vs v8-stable-cn testing donotuse v8-stable-build"
