...
SPECOPTIONS="v5-stable v6-stable v6-beta v7-stable v7-beta v7-devel v8-devel libestr libee libgt librelp json-c liblognorm liblognorm1 liblogging openpgm zeromq3 czmq libmongo-client python-docutils jemalloc"
